...
const inputRangeClasses = 'w-[328px] appearance-none w-full h-[2px] bg-[#263800] rounded-lg outline-none';
const selectClasses = 'w-full bg-zinc-200 text-zinc-700 py-2 px-3 rounded-lg focus:outline-none';
...
const CalorieCalculator = () => {
    ...
    return (
        <div className="min-h-screen p-8 mt-[248px]">
            <div className='container z-30 relative'>
                ...
                <div className='flex space-x-6'>
                    <div className="w-full mx-auto bg-[#FFFBE6] p-6 rounded-lg shadow-xl">
                        <div className="flex space-x-6">
                        ...
                        <div className="flex flex-wrap justify-between mt-8">
                            <div className="w-full md:w-1/2 p-4">
                                ...
                                <div className="mt-6 w-[100%] max-w-[289px] min-w-[100px]">
                                    <label className="block text-zinc-700">GOAL</label>
                    ...
                    <div className="w-full md:w-1/3 p-4 bg-yellow-50 rounded-lg shadow-md flex flex-col items-center pt-[119px]">
