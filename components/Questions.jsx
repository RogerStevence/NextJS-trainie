        ...
        <div className='z-40 relative'>
            ...
            <div className='sm:hidden mt-[114px]'>
                <div className='h-full flex flex-col items-end mx-4'>
                    <form action="" className='flex flex-col max-w-[670px] h-[599px] items-center shadow-[2px_6px_15px_0_rgba(0,0,0,0.25)] bg-[#FFFCEC] rounded-[15px] px-4'>
                        <div className='flex flex-col items-center'>
                            <h1 className='text-primary text-center mt-[32px] text-[32px]'>HAVE <span className='text-seccondary font-semibold'>QUESTIONS</span>?</h1>
                            <p className='leading-5 text-[14px] text-[#263800] text-center w-[100%] max-w-[491px] mt-[18px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eget justo, neque, a vitae neque phasellus ultrices. Nunc vel amet, adipiscing erat pulvinar id vestibulum, malesuada morbi. </p>
                        </div>
                        <div className='mt-[32px] flex flex-col w-[100%] max-w-[546px] space-y-[16px] text-primary '>
                            ...
                            <textarea name="" id="" cols="30" rows="6" className='text-primary shadow-xl pl-[16px] pt-[11px] resize-none focus:outline-none' placeholder='Enter your message here'></textarea>
                        </div>
                        <button className='w-full min-w-[100px] max-w-[219px] h-[56px] rounded-[8px] bg-[#ECBD00] text-[#FFFCEC] cursor-pointer uppercase mt-[24px] shadow-[2px_6px_15px_0_rgba(0,0,0,0.25)]'>send</button>
                    </form>
                </div>
            </div>
